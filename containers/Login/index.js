...
function LoginContainer() {
    ...
    const handleFormSubmit = (e) => {
        ...
        api.post(`${routes.login}`, { identifier, password })
            .then((response) => {
            ...
            <Wrapper>
                <ContainerBlanco>
                    <>
                        ...
                        >
                            <input className="input" name="email" type="text" placeholder="Usuario" />
                            <input className="input" name="password" type="text" placeholder="Contraseña" />
