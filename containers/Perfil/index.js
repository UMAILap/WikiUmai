...
import { ContainerMain, ContainerBanner, Titulo, WrapperCreaciones } from './styles';
import { Wrapper, WrapperPersonajesPlanetas } from 'components';
import { MiPerfil, ListaPerfil, Personajes } from 'components';
        ...
        <ContainerMain>
            ...
            <WrapperPersonajesPlanetas>
                ...
                <WrapperCreaciones>
                    ...
                    <Personajes personajes={arrayPersonajes}></Personajes>
                </WrapperCreaciones>
            </WrapperPersonajesPlanetas>
        </ContainerMain>
    );
